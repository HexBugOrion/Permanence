...
public class BitumenBlock extends TransparentBlock {
    ...
    private static boolean hasBitumenBlockEffects(Entity entity) {
        return entity instanceof LivingEntity || entity instanceof AbstractMinecartEntity
            || entity instanceof TntEntity || entity instanceof BoatEntity;
    }
    ...
    private void updateSlidingVelocity(Entity entity) {
        ...
        if (vec3d.y < -0.13D) {
            ...
            entity.setVelocity(new Vec3d(vec3d.x * d, -0.00D, vec3d.z * d));
        } else {
            entity.setVelocity(new Vec3d(vec3d.x, -0.00D, vec3d.z));
        }
    ...
    private void addCollisionEffects(World world, Entity entity) {
        if (hasBitumenBlockEffects(entity)) {
